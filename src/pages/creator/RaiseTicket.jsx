...
import { tickets, myCourses, currentCreator } from '../../data/mockData';
...
const COURSE_OPTIONS = ['—', ...myCourses.map((course) => course.title)];
...
export default function RaiseTicket() {
  const [ticketList, setTicketList] = useState(() => tickets.filter((ticket) => ticket.submittedBy === currentCreator.name));
    ...
    setTicketList((prev) => [
      {
        ...
        submittedBy: currentCreator.name,
        course: form.course,
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Video upload failing to process"
